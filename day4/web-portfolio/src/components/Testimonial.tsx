    ...
    <div className="mx-auto max-w-6xl px-6 font-mono-label" id="testimonial">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 my-10">
        {testimonials.map((test) => (
          <div
            className="flex flex-col pb-4 bg-[#111111] border-2 border-[#262626] rounded-2xl px-8 pt-6 text-zinc-300 font-display transition-all duration-300 hover:-translate-y-1 hover:border-blue-500/40"
            key={test.name}
          >
            <StarRating />
